...
/**
 * @title DeployGridLadder
 * @notice Deploys GridLadder deterministically to any chain with a Uniswap v4 `PoolManager`.
 *
...
contract DeployGridLadder is Script {
    ...
    function run() external {
        ...
        console2.log("GridLadder ", predicted);
        ...
        require(
            keccak256(bytes(IHookMetadata(address(hook)).hookName())) == keccak256(bytes("GridLadder")),
